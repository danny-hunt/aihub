...
export declare namespace StreamChunk {
    interface Choice {
        delta: Choice.Delta;
        index: number;
...
export declare namespace ChatCreateParams {
    type ChatCreateParamsNonStreaming = ChatAPI.ChatCreateParamsNonStreaming;
    type ChatCreateParamsStreaming = ChatAPI.ChatCreateParamsStreaming;
}
...
export declare namespace Chat {
    export { type Completion as Completion, type CompletionRequest as CompletionRequest, type StreamChunk as StreamChunk, type ChatCreateParams as ChatCreateParams, type ChatCreateParamsNonStreaming as ChatCreateParamsNonStreaming, type ChatCreateParamsStreaming as ChatCreateParamsStreaming, };
}
