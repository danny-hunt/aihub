...
const root_1 = require("./resources/root.js");
...
class Dedalus {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('DEDALUS_BASE_URL'), apiKey = (0, env_1.readEnv)('DEDALUS_API_KEY'), ...opts } = {}) {
        _Dedalus_instances.add(this);
        _Dedalus_encoder.set(this, void 0);
        this.root = new API.Root(this);
        this.health = new API.Health(this);
        this.models = new API.Models(this);
        this.chat = new API.Chat(this);
        if (apiKey === undefined) {
            throw new Errors.DedalusError("The DEDALUS_API_KEY environment variable is missing or empty; either provide it, or instantiate the Dedalus client with an apiKey option, like new Dedalus({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
...
Dedalus.Root = root_1.Root;
Dedalus.Health = health_1.Health;
