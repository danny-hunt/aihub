...
import { DedalusError } from "./error.mjs";
...
export async function* _iterSSEMessages(response, controller) {
    if (!response.body) {
        ...
        if (typeof globalThis.navigator !== 'undefined' &&
            ...
            throw new DedalusError(`The default react-native fetch implementation does not support streaming. Please use expo/fetch: https://docs.expo.dev/versions/latest/sdk/expo/#expofetch-api`);
        }
