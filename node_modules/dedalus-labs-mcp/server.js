...
function initMcpServer(params) {
    ...
    const client = new dedalus_labs_1.default(params.clientOptions);
    const capabilities = {
...
function init(params) {
    ...
    const client = params.client || new dedalus_labs_1.default({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
