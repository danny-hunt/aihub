...
const types_1 = require("dedalus-labs-mcp/tools/types");
exports.metadata = {
    resource: 'chat',
    operation: 'write',
    tags: [],
        ...
        anyOf: [
            {
                ...
                properties: {
                    ...
                    input: {
                        type: 'array',
                        title: 'Input',
                        description: 'Input to the model - can be messages, images, or other modalities. Supports OpenAI chat format with role/content structure. For multimodal inputs, content can include text, images, or other media types.',
                        items: {
                            type: 'object',
                        },
                    },
                    ...
                    model: {
                        ...
                        title: 'Model',
                        description: "Model(s) to use for completion. Can be a single model ID or a list for multi-model routing. Single model: 'gpt-4', 'claude-3-5-sonnet-20241022', 'gpt-4o-mini'. Multi-model routing: ['gpt-4o-mini', 'gpt-4', 'claude-3-5-sonnet'] - agent will choose optimal model based on task complexity.",
                    },
                    model_attributes: {
                        type: 'object',
                    ...
                    stream: {
                        type: 'string',
                        title: 'Stream',
                        description: 'Whether to stream back partial message deltas as Server-Sent Events. When true, partial message deltas will be sent as chunks in OpenAI format.',
                        enum: [false],
                    },
                    temperature: {
                        type: 'number',
...
const handler = async (client, args) => {
    const body = args;
    return (0, types_1.asTextContentResult)(await client.chat.create(body));
};
